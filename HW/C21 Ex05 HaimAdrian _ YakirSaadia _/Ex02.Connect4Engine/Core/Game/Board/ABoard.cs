...
using Ex02.Connect4Engine.Core.Matrix;
...
namespace Ex02.Connect4Engine.Core.Game.Board
{
	...
	internal abstract class ABoard<T> : IBoard<T>
	{
		...
		private static void appendStringCentered(StringBuilder i_StringBuilder, string i_StringToAppend, int i_Width)
		{
		...
		public abstract void AddBoardUpdatingListener(Action<IBoard<T>, Index, T> i_Listener);

		public abstract void AddBoardUpdatedListener(Action<IBoard<T>, ICollection<Index>> i_Listener);

		public abstract void SuspendUpdates();

		public abstract void ResumeUpdates();

		public abstract IBoard<T> Clone();
