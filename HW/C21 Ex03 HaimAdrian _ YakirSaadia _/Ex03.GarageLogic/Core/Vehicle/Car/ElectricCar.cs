...
{
	internal class ElectricCar : AElectricVehicle, IElectricCar
	{
		private readonly CarSpecific r_CarSpecific;

		public ElectricCar(string i_Brand, string i_LicenseNumber) : base(i_Brand, i_LicenseNumber)
		{
		...
		protected override void InitDefaults()
		{
			...
			BatteryTimeMaxHours = CarDefaults.MaxBatteryTimeHours;
		}
